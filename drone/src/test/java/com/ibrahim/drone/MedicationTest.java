...
import com.ibrahim.drone.Controllers.MedicationController;
...
@ContextConfiguration(classes = {MedicationService.class, MedicationController.class, MedicationRepository.class})
